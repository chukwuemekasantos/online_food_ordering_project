    	 ...
    	 <div class="col-md-4 compose">   	 	
    	 	<div class="mail-profile">
    	 		<div class="mailer-name"> 			
    	 				<h5><a href="#"><?=$_SESSION['data']['admin_name']?></a></h5>  	 				
    	 			     <h6><a href="#"><?=$_SESSION['data']['admin_email']?></a></h6>   
    	 		</div>
	                ...
	                <table class="table tab-border">
	                    <tbody>
	                        ...
	                        <tr class="unread checked">
	                            ...
	                            <td><?=$value['users_message']?></td>
	                            <td><?php echo date("m/d/Y", strtotime($value['time_sent']))?></td>
