			...
			<div class="compose-right">
					<div class="inbox-details-default" style="border-style: none;">
						...
						<div class="inbox-details-body">
								          ...
								          <div class="alert alert-danger alert-dismissible col-md-12" id="productexit">
								          <button type="button" class="close" data-dismiss="alert">&times;</button>
								             Item is already Added! 
								        </div>

								        <div class="alert alert-success alert-dismissible col-md-12" id="productadded">
								          <button type="button" class="close" data-dismiss="alert">&times;</button>
								            Item is added successfully!
								        </div>
								       
							<form method="POST" id="addfooditem">
								<div class="form-group">
								  <input type="text" class="form-control" id="usr" value="Product Name :" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Product Name';}" name="productname" required="">
								</div>

								<div class="form-group">
								  <input type="text" class="form-control" id="usr" value="Product Price :" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Product Price';}" name="productprice" required="">
								</div>
								
								 <div class="form-group">
									  <select class="form-control" id="sel1" name="productcategory" required="">
								 ...
								 <div class="form-group">
									  <select class="form-control" id="sel1" name="producttype" required="">
								...
								<input type="submit" value="Add" style="text-align: right;" name="add" onclick="addfooditem()"> 
							</form>
						</div>
					</div>
				</div>
